...
1. Make a really basic program with easy task like it is shown on the slide 1.
...
3. Don't use comment where the code is self-explanatory.
...
1. If we want to repeat some programming instructions for several times
    we can use For Loop.
1. For example the next program repeats the functions robotLeft() and
